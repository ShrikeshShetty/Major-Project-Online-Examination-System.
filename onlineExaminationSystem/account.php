...
<link  rel="stylesheet" href="css/bootstrap.min.css"/>
 ...
 <style>
  body{
    background-image:url("acc-home2.jpg");
...
if(@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
    ...
    // Fetch the question
    $q = mysqli_query($con, "SELECT * FROM questions WHERE eid='$eid' AND sn='$sn'") or die('Error in fetching questions: ' . mysqli_error($con));
    ...
    $q = mysqli_query($con, "SELECT * FROM options WHERE qid='$qid'") or die('Error in fetching options: ' . mysqli_error($con));
